...
const FunctionDisplay = ({ toolCall }) => {
    ...
    const statusConfig = {
        ...
        running: { icon: Loader2, color: 'text-slate-500', text: 'Searching library...', spin: true },
        in_progress: { icon: Loader2, color: 'text-slate-500', text: 'Searching library...', spin: true },
        completed: isError
...
export default function MessageBubble({ message }) {
    ...
    return (
        <div className={cn("flex gap-3", isUser ? "justify-end" : "justify-start")}>
            {!isUser && (
                <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-blue-600 to-indigo-600 flex items-center justify-center mt-0.5 shrink-0">
